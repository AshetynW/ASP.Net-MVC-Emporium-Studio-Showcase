...
namespace ASP_Web_Proto.Models
{
    public class CharacterModel
    {
        public RPGCharacter newPlayer = new RPGCharacter();
    ...
    public class Rogue
    {
        public string Description { get; } = "A scoundrel who uses stealth and trickery to overcome obstacles and enemies.";
    }
    public class Barbarian
    {
        public string Description { get; } = "A fierce warrior of primitive background who can enter a battle rage.";
    }
    public class Bard
    {
        public string Description { get; } = "An inspiring magician whos power echoes the music of creation.";
    }
    public class Cleric
    {
        public string Description { get; } = "A priestly champion who wields divine magic in service of a higher power.";
    }
    public class Druid
    {
        public string Description { get; } = "A priest of the old faith, wielding the powers of nature and adopting animal forms.";
    }
    public class Fighter
    {
        public string Description { get; } = "A master of martial combat skilled with a variety of weapons and armor.";
    }
    public class Adventurer
    {
        public string Description { get; } = "Commonly found on roads or inns and a universally capable 'Jack of all trades.'";
    }
}